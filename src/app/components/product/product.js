...
export default function Product() {
 ...
 <p className='absolute text-[#60e796]    lg:text-5xl text-4xl   font-bold '>Conversational</p>
    <Image alt="conversation" className='md:w-[65%] w-[45%] mt-[20%]  lg:mt-[24%] ' src='/convo.png' />
  </div>
  <div className='w-1/3 mt-[10%] text-center hidden sm:block'>
  <Image alt="badge" className=' lg:w-[74%] md:w-[100em]  px-10  mt-[4%] inline-block' src='/play-badge.png' />
  <Image alt="badge" className=' lg:w-[85%] md:w-[100em] mt-[-10%] px-10 inline-block' src='/app-badge.png' />
</div>
    ...
    <Image  className='sm:w-[65%] w-[45%] mt-[20%] lg:mt-[24%]' src='/trans.png' alt="Translation"/>
  </div>
  <div className='sm:w-1/3 mt-[10%] text-center sm:hidden block'>
  <Image className='sm:w-[74%] w-[54%]  px-10  mt-[4%] inline-block' src='/play-badge.png' alt="Play Badge"/>
  <Image className='sm:w-[85%] w-[61%] mt-[-10%] px-10 inline-block' src='/app-badge.png' alt="App Badge"/>
</div>
