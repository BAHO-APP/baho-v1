export function Footer(){
  ...
  At BAHO-APP, our mission is to pioneer the advancement of voice technologies using artificial intelligence for Native African languages. BAHO-APP started with kinyarwanda language to pave the way, empower communities  and preserve our undereppresented native African languages in the digital landscape</p>
        ...
        <main  style={{ backgroundImage: "url('/giraffe.jpg')" }} className="text-center    bg-cover bg-no-repeat bg-center" >
           
            <div className="  flex h-96  items-end  justify-end  mr-4 md:space-x-[30%] ">
               
                <div className="flex">
                    <p className="font-bold mt-[1%] text-sm mr-1 text-[#ffffff]">Powered By</p>
                <p className="text-[#27603e]  text-1xl font-bold "> BAHO-APP </p>
                <p className="text-[#27603e] mt-[3%]  text-xs font-bold  ml-[0.2em]">CBC</p>
                </div>
            </div>
        </main>
        </div>
